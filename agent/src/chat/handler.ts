...
import { type LlmCallConfig, type LlmCallResult } from "../planner/llm-via-cli.js";
...
export async function handleChatMessage(
  ...
  // Log assistant message for debugging — must use stderr (stdout is reserved for IPC)
